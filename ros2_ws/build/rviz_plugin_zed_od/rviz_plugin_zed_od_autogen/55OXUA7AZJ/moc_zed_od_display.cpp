...
#include "src/plugin/include/zed_od_display.hpp"
...
QT_INIT_METAOBJECT const QMetaObject rviz_plugin_zed_od::displays::ZedOdDisplay::staticMetaObject = { {
    &rviz_common::MessageFilterDisplay<zed_interfaces::msg::ObjectsStamped>::staticMetaObject,
...
void *rviz_plugin_zed_od::displays::ZedOdDisplay::qt_metacast(const char *_clname)
{
    ...
    return rviz_common::MessageFilterDisplay<zed_interfaces::msg::ObjectsStamped>::qt_metacast(_clname);
}

int rviz_plugin_zed_od::displays::ZedOdDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = rviz_common::MessageFilterDisplay<zed_interfaces::msg::ObjectsStamped>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 7)
