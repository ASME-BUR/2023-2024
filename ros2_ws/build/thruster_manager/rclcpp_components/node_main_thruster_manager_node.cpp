...
#define NODE_MAIN_LOGGER_NAME "thruster_manager_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libthruster_manager.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<thruster_manager::ThrusterManagerNode>";
