...
#ifndef ZED_INTERFACES__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
#define ZED_INTERFACES__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
 ...
 * calls
 * zed_interfaces__srv__SetPose_Request__init().
...
/**
 * It calls
 * zed_interfaces__srv__SetPose_Request__fini()
 ...
 * zed_interfaces__srv__SetPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * zed_interfaces__srv__SetPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zed_interfaces__srv__SetPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zed_interfaces
...
/**
 * It calls
 * zed_interfaces__srv__SetPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zed_interfaces
...
/**
 * It allocates the memory for the array and calls
 * zed_interfaces__srv__SetPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zed_interfaces
...
/**
 * It calls
 * zed_interfaces__srv__SetPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ZED_INTERFACES__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
