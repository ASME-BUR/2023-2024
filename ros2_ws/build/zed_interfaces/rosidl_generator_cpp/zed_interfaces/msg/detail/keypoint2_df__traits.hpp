...
inline std::string to_yaml(const Keypoint2Df & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const zed_interfaces::msg::Keypoint2Df & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const zed_interfaces::msg::Keypoint2Df & msg)
{
