...
bool zed_interfaces__msg__bounding_box2_df__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_interfaces.msg._bounding_box2_df.BoundingBox2Df", full_classname_dest, 51) == 0);
  }
  zed_interfaces__msg__BoundingBox2Df * ros_message = _ros_message;
  {  // corners
    ...
    Py_ssize_t size = 4;
    zed_interfaces__msg__Keypoint2Df * dest = ros_message->corners;
...
PyObject * zed_interfaces__msg__bounding_box2_df__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_interfaces.msg._bounding_box2_df");
