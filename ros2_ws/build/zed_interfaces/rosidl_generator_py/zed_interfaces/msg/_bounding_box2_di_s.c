...
bool zed_interfaces__msg__bounding_box2_di__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_interfaces.msg._bounding_box2_di.BoundingBox2Di", full_classname_dest, 51) == 0);
  }
  zed_interfaces__msg__BoundingBox2Di * ros_message = _ros_message;
  {  // corners
    ...
    Py_ssize_t size = 4;
    zed_interfaces__msg__Keypoint2Di * dest = ros_message->corners;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!zed_interfaces__msg__keypoint2_di__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of BoundingBox2Di */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_interfaces.msg._bounding_box2_di");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoundingBox2Di");
  ...
  {  // corners
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = zed_interfaces__msg__keypoint2_di__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
