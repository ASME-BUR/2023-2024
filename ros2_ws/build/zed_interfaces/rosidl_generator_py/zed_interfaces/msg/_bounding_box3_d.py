...
class BoundingBox3D(metaclass=Metaclass_BoundingBox3D):
    ...
    _fields_and_field_types = {
        'corners': 'zed_interfaces/Keypoint3D[8]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['zed_interfaces', 'msg'], 'Keypoint3D'), 8),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'corners' field must be a set or sequence with length 8 and each value of type 'Keypoint3D'"
        self._corners = value
