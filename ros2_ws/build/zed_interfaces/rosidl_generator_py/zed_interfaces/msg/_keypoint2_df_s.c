...
bool zed_interfaces__msg__keypoint2_df__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_interfaces.msg._keypoint2_df.Keypoint2Df", full_classname_dest, 44) == 0);
  }
  zed_interfaces__msg__Keypoint2Df * ros_message = _ros_message;
  {  // kp
...
{
  /* NOTE(esteve): Call constructor of Keypoint2Df */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_interfaces.msg._keypoint2_df");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Keypoint2Df");
