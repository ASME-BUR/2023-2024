...
bool zed_interfaces__msg__skeleton3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_interfaces.msg._skeleton3_d.Skeleton3D", full_classname_dest, 42) == 0);
  }
  zed_interfaces__msg__Skeleton3D * ros_message = _ros_message;
  {  // keypoints
    ...
    Py_ssize_t size = 70;
    zed_interfaces__msg__Keypoint3D * dest = ros_message->keypoints;
...
PyObject * zed_interfaces__msg__skeleton3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_interfaces.msg._skeleton3_d");
