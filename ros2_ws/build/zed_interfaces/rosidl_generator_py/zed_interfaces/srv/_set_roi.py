    ...
    def roi(self, value):
        if __debug__:
            assert \
                ...
                "The 'roi' field must be of type 'str'"
        self._roi = value
...
class Metaclass_SetROI(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from zed_interfaces.srv import _set_roi
...
class SetROI(metaclass=Metaclass_SetROI):
    from zed_interfaces.srv._set_roi import SetROI_Request as Request
    from zed_interfaces.srv._set_roi import SetROI_Response as Response
