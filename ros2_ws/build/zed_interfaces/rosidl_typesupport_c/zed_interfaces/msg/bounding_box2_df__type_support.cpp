...
static const _BoundingBox2Df_type_support_symbol_names_t _BoundingBox2Df_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, msg, BoundingBox2Df)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_interfaces, msg, BoundingBox2Df)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zed_interfaces, msg, BoundingBox2Df)() {
  return &::zed_interfaces::msg::rosidl_typesupport_c::BoundingBox2Df_message_type_support_handle;
}
