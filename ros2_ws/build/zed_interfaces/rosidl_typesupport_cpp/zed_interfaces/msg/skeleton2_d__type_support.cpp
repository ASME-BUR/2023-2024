...
static const _Skeleton2D_type_support_symbol_names_t _Skeleton2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, msg, Skeleton2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, msg, Skeleton2D)),
  }
};
...
{
  return &::zed_interfaces::msg::rosidl_typesupport_cpp::Skeleton2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_interfaces, msg, Skeleton2D)() {
  return get_message_type_support_handle<zed_interfaces::msg::Skeleton2D>();
}
