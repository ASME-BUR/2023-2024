...
#include "zed_interfaces/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox3D__ros_msg_type = zed_interfaces__msg__BoundingBox3D;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces__msg__BoundingBox3D;
    is_plain =
      (
...
static size_t _BoundingBox3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_interfaces__msg__BoundingBox3D(
