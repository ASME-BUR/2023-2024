...
#include "zed_interfaces/msg/detail/depth_info_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _DepthInfoStamped__ros_msg_type = zed_interfaces__msg__DepthInfoStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DepthInfoStamped__ros_msg_type * ros_message = static_cast<const _DepthInfoStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DepthInfoStamped__ros_msg_type * ros_message = static_cast<_DepthInfoStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces__msg__DepthInfoStamped;
    is_plain =
      (
      offsetof(DataType, max_depth) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _DepthInfoStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_zed_interfaces__msg__DepthInfoStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, msg, DepthInfoStamped)() {
