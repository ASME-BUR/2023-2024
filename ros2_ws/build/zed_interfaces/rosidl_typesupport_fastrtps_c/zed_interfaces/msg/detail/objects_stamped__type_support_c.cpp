...
#include "zed_interfaces/msg/detail/objects_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectsStamped__ros_msg_type = zed_interfaces__msg__ObjectsStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectsStamped__ros_msg_type * ros_message = static_cast<const _ObjectsStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zed_interfaces, msg, Object
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectsStamped__ros_msg_type * ros_message = static_cast<_ObjectsStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      zed_interfaces__msg__Object__Sequence__fini(&ros_message->objects);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_zed_interfaces__msg__Object(
  ...
  size_t current_alignment)
{
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_zed_interfaces__msg__Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces__msg__ObjectsStamped;
    is_plain =
      (
...
static size_t _ObjectsStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_zed_interfaces__msg__ObjectsStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, msg, ObjectsStamped)() {
