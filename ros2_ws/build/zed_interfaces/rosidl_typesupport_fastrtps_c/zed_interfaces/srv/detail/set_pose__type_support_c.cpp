...
#include "zed_interfaces/srv/detail/set_pose__rosidl_typesupport_fastrtps_c.h"
...
using _SetPose_Request__ros_msg_type = zed_interfaces__srv__SetPose_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->orient;
    cdr.serializeArray(array_ptr, size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces__srv__SetPose_Request;
    is_plain =
      (
...
static size_t _SetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_interfaces__srv__SetPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, SetPose_Request)() {
...
using _SetPose_Response__ros_msg_type = zed_interfaces__srv__SetPose_Response;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zed_interfaces__srv__SetPose_Response;
    is_plain =
      (
...
static size_t _SetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_interfaces__srv__SetPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, SetPose_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, SetPose)() {
