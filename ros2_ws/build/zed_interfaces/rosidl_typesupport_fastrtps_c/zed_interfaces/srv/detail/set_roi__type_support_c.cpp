...
#include "zed_interfaces/srv/detail/set_roi__rosidl_typesupport_fastrtps_c.h"
...
using _SetROI_Request__ros_msg_type = zed_interfaces__srv__SetROI_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SetROI_Request__ros_msg_type * ros_message = static_cast<const _SetROI_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: roi
  {
    const rosidl_runtime_c__String * str = &ros_message->roi;
  ...
  void * untyped_ros_message)
{
  ...
  _SetROI_Request__ros_msg_type * ros_message = static_cast<_SetROI_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: roi
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->roi.data) {
      rosidl_runtime_c__String__init(&ros_message->roi);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->roi,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'roi'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces__srv__SetROI_Request;
    is_plain =
      (
...
static size_t _SetROI_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_interfaces__srv__SetROI_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, SetROI_Request)() {
...
using _SetROI_Response__ros_msg_type = zed_interfaces__srv__SetROI_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SetROI_Response__ros_msg_type * ros_message = static_cast<const _SetROI_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SetROI_Response__ros_msg_type * ros_message = static_cast<_SetROI_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zed_interfaces__srv__SetROI_Response;
    is_plain =
      (
...
static size_t _SetROI_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_interfaces__srv__SetROI_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, SetROI_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, SetROI)() {
