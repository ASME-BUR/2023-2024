...
#include "zed_interfaces/msg/detail/bounding_box2_df__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces::msg::BoundingBox2Df;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zed_interfaces::msg::BoundingBox2Df *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_interfaces::msg::BoundingBox2Df *>(
    untyped_ros_message);
...
{
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBox2Df__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, msg, BoundingBox2Df)() {
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBox2Df__handle;
}
