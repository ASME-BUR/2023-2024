...
#include "zed_interfaces/msg/detail/depth_info_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces::msg::DepthInfoStamped;
    is_plain =
      (
...
static size_t _DepthInfoStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DepthInfoStamped(full_bounded, is_plain, 0);
...
{
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_DepthInfoStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, msg, DepthInfoStamped)() {
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_DepthInfoStamped__handle;
}
