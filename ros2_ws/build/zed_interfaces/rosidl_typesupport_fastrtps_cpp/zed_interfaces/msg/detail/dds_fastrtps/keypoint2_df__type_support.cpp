...
#include "zed_interfaces/msg/detail/keypoint2_df__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces::msg::Keypoint2Df;
    is_plain =
      (
...
static size_t _Keypoint2Df__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Keypoint2Df(full_bounded, is_plain, 0);
...
{
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_Keypoint2Df__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, msg, Keypoint2Df)() {
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_Keypoint2Df__handle;
}
