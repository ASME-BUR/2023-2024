...
#include "zed_interfaces/msg/detail/keypoint3_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces::msg::Keypoint3D;
    is_plain =
      (
...
{
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_Keypoint3D__handle;
}
