...
#include "zed_interfaces/srv/detail/set_roi__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces::srv::SetROI_Request;
    is_plain =
      (
...
{
  return &zed_interfaces::srv::typesupport_fastrtps_cpp::_SetROI_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, srv, SetROI_Request)() {
  return &zed_interfaces::srv::typesupport_fastrtps_cpp::_SetROI_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zed_interfaces::srv::SetROI_Response;
    is_plain =
      (
...
{
  return &zed_interfaces::srv::typesupport_fastrtps_cpp::_SetROI_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, srv, SetROI_Response)() {
  return &zed_interfaces::srv::typesupport_fastrtps_cpp::_SetROI_Response__handle;
}
...
{
  return &zed_interfaces::srv::typesupport_fastrtps_cpp::_SetROI__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, srv, SetROI)() {
  return &zed_interfaces::srv::typesupport_fastrtps_cpp::_SetROI__handle;
}
